...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Leonardo:" + devLeonardo.getConteudoInscritos());
        ...
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Leonardo:" + devLeonardo.getConteudoInscritos());
        System.out.println("Conteúdos Concluidos Leonardo:" + devLeonardo.getConteudoConcluidos());
